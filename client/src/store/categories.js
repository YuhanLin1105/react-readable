...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        case FETCH_CATEGORIES_START: return fetchStart(state, action);
        case FETCH_CATEGORIES_SUCCESS: return fetchSuccess(state, action);
        case FETCH_CATEGORIES_FAIL: return fetchFail(state, action);
